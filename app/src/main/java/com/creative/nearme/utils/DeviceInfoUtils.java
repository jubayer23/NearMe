package com.creative.nearme.utils;
...
import com.creative.nearme.BuildConfig;
...
public class DeviceInfoUtils {
    ...
    public static boolean checkGps(Context context) {
        ...
        if (!isGoogelPlayInstalled(context)) {
    ...
    public static boolean isGoogelPlayInstalled(Context context) {
